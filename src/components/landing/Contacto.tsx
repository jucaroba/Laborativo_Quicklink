    ...
    <section style={{ padding: '80px 56px', borderBottom: '1.5px solid var(--ink)', background: 'var(--bg)' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 40, marginTop: 32 }}>
        ...
        <div style={{
          ...
          {/* Icono grande + descripción al lado derecho */}
          <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginTop: 10 }}>
            <svg width="56" height="56" viewBox="0 0 24 24" fill="currentColor" style={{ flexShrink: 0 }}>
            ...
            <p style={{
              ...
              Sondea la cultura de tu organización en sus cuatro dimensiones: intención, motivación, interacción y acción. Sin costo y sin compromiso.
            </p>
          </div>
