  ...
  return (
    <section style={{ padding: '80px 56px', borderBottom: '1.5px solid var(--ink)', background: 'var(--bg)' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 40, marginTop: 32 }}>
        {/* Lado izquierdo: headline + form + info */}
        <div>
          <h2 style={{
            fontWeight: 900,
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '2.5fr 1fr', gap: 0, marginTop: 36 }}>
            {/* Sub-columna izquierda: formulario */}
            <div style={{ paddingRight: 40 }}>
              ...
              <form onSubmit={handleSubmit} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
                ...
                <textarea
                  ...
                  style={{ ...inputStyle, gridColumn: '1 / 2', resize: 'none', fontFamily: 'inherit', minHeight: 110 }}
                  required
                />
                <button
                  type="submit"
              ...
              {/* Slot reservado para el mensaje de éxito/error: siempre ocupa el mismo alto para no mover el form */}
              <div style={{ minHeight: 20, marginTop: 10, fontSize: 13, lineHeight: 1.4 }}>
                {estado === 'ok' && (
            ...
            {/* Sub-columna derecha: info */}
            <div style={{ paddingLeft: 24, display: 'flex', flexDirection: 'column', gap: 8, alignSelf: 'end' }}>
              <div>
        ...
        {/* Lado derecho: caja negra con CTA de diagnóstico gratuito */}
        <div style={{
          background: 'var(--ink)',
          color: '#fff',
          padding: '12px 45px',
          ...
          <h3 style={{
            ...
            Empecemos nuestra<br />
            relación con el<br />
            diagnóstico gratuito.
          </h3>

          {/* Descripción: full-width, alineada a la izquierda */}
          <p style={{
            fontSize: 14,
            lineHeight: 1.5,
            fontWeight: 500,
          ...
          {/* Fila inferior: ícono WhatsApp (fuera del botón) + botón Agendar */}
          <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginTop: 8, marginBottom: 30 }}>
            <svg width="48" height="48" viewBox="0 0 24 24" fill="#fff" style={{ flexShrink: 0 }}>
