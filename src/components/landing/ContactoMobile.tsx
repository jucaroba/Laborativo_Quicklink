    ...
    <section style={{ padding: '48px 20px 56px', borderBottom: '1.5px solid var(--ink)', background: 'var(--bg)' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          <svg width="56" height="56" viewBox="0 0 24 24" fill="currentColor" style={{ flexShrink: 0, color: '#fff' }}>
          ...
          <p style={{
            ...
            Te ayudamos a sondear la cultura de tu organización en las cuatro grandes dimensiones que la sostienen: intención, motivación, interacción y acción. Sin costo y sin compromiso.
          </p>
        </div>
